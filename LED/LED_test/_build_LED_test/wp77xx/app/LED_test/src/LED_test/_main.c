...
// Startup code for the executable 'LED_test'.
...
LE_SHARED const char* _led_Component_le_gpioPin23_ServiceInstanceName = "LED_test.led_Component.le_gpioPin23";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t LED_test_exe_LogSession;
LE_SHARED le_log_Level_t* LED_test_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    LED_test_exe_LogSession = log_RegComponent("LED_test_exe", &LED_test_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_led_Component.so");
