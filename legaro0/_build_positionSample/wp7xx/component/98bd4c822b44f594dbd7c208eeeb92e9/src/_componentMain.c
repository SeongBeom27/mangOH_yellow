...
extern const char* _position_component_imu_ServiceInstanceName;
const char** imu_ServiceInstanceNamePtr = &_position_component_imu_ServiceInstanceName;
void imu_AdvertiseService(void);
extern const char* _position_component_temperature_ServiceInstanceName;
const char** temperature_ServiceInstanceNamePtr = &_position_component_temperature_ServiceInstanceName;
