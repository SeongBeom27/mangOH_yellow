...
// Startup code for the executable 'positionTest'.
...
LE_SHARED const char* _position_component_imu_ServiceInstanceName = "positionTest.position_component.imu";
LE_SHARED const char* _position_component_temperature_ServiceInstanceName = "positionTest.position_component.temperature";
LE_SHARED const char* _position_component_le_posCtrl_ServiceInstanceName = "positionTest.position_component.le_posCtrl";
LE_SHARED const char* _position_component_le_pos_ServiceInstanceName = "positionTest.position_component.le_pos";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t positionTest_exe_LogSession;
LE_SHARED le_log_Level_t* positionTest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    positionTest_exe_LogSession = log_RegComponent("positionTest_exe", &positionTest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_position_component.so");
