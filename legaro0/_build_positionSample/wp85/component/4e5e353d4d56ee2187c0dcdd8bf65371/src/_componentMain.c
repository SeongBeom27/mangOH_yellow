...
extern const char* _position_component_le_avdata_ServiceInstanceName;
const char** le_avdata_ServiceInstanceNamePtr = &_position_component_le_avdata_ServiceInstanceName;
